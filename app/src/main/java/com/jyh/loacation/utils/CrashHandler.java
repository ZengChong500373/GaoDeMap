package com.jyh.loacation.utils;
...
import com.jyh.loacation.GaodeApplication;
...
//						+ "/crashinfo/";
				...
				String path= GaodeApplication.getContext().getExternalFilesDir(null).getAbsolutePath()+ "/crashinfo/";
				//创建文件夹和文件
